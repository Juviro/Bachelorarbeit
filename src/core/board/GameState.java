...
import static core.board.Move.MoveDirection.*;

public class GameState {

    /**
     * core.board positions, represented by the last 49 digits of a binary long
     * core.board position = 64 - NumberOrLeadingZeros(positionAsLong)
